...
def main():
    """Reads and filters data from a database using a logger.
    """
    ...
    with connection.cursor() as cur:
        ...
        for row in rows:
            ...
            mail = '{};'.format('; '.join(list(record)))  
            args = ("user_data", logging.INFO, None, None, mail, None, None)
